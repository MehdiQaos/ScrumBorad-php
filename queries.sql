...
CREATE TABLE Tasks (
    ...
    FOREIGN KEY (type_id) REFERENCES Types(types_id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (status_id) REFERENCES Statuses(statuses_id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (priority_id) REFERENCES Priorities(priorities_id) ON DELETE CASCADE ON UPDATE CASCADE
);
